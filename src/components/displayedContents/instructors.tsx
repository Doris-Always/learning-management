    ...
    return(
        <>
            <div className="flex flex-col ">
                <h2 className="hidden md:block font-semibold text-lg m-10">Instructors</h2>
                ...
                <div className="empty-contents p-8 flex flex-col justify-center items-center lg:mx-60">
                    ...
                    <button className=" create-cohort-btn w-44 h-10 rounded text-white ">Invite instructors</button>
                </div>
            </div>
        </>
    )
